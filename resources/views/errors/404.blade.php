...
@section('content')
    <section class="pt-[175px] pb-[87.5px] flex flex-col justify-center text-center">
        <div class="flex flex-col gap-y-[40px]">
            <div class="flex flex-col gap-y-[30px]">
                <h2 class="text-[#FC165B] font-semibold text-[16px] tracking-[3px] leading-[32px]">ERROR
                </h2>
                <h1 class="text-white font-bold text-[36px] leading-[54px]">The page you are looking<br /> for is not on this
                    website,<br /> please check again</h1>
                <p class="text-white/60 font-medium leading-[32px] text-[16px]">The system cannot find the page you are
