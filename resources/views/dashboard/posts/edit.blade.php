            ...
            <form action="{{ route('dashboard.posts.update', $post->id) }}" method="POST"
                ...
                <div class="flex flex-col">
                    ...
                    <input type="number" name="reading_time" id="reading_time"
                        value="{{ old('reading_time', $post->reading_time[0]) }}"
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="tags" id="tags"
                        value="{{ old('tags', implode(',', json_decode($post->tags))) }}"
                ...
                <div class="flex flex-col">
                    ...
                    <!-- Image Preview -->
                    <img src="{{ asset('/storage/' . $post->image) }}" alt="image-preview" id="image-preview"
