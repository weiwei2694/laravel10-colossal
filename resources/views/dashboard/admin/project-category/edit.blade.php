...
@section('content')
    <section class="border bg-white rounded shadow-sm">
        <div class="p-[20px] border-b">
            <h1 class="font-semibold text-black text-lg">Edit Project Category</h1>
        </div>
        <div class="p-[20px]">
            <form action="{{ route('dashboard.project-categories.update', $project_category->id) }}" method="POST"
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="name" id="name" autofocus
                        value="{{ old('name', $project_category->name) }}" placeholder="Name"
